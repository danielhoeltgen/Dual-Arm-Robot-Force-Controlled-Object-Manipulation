^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
Changelog for package joint_trajectory_admittance_controller
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
0.8.1 (2014-07-11)
------------------
* joint_trajectory_admittance_controller: Critical targets declared before calling catkin_package
...
0.5.3 (2013-09-04)
------------------
* joint_trajectory_admittance_controller: New package implementing a controller for executing joint-space trajectories on a
  set of joints.
